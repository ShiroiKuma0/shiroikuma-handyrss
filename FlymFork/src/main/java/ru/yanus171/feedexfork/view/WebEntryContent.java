...
public class WebEntryContent {
    ...
    private static String GetCSS(final String text, final String url, boolean isEditingMode) {
        ...
        String h1Size = headingSizeSp > 0 ? (headingSizeSp + "pt") : PrefUtils.getFontSizeText(4 );
        String h2Size = headingSizeSp > 0 ? ((headingSizeSp - 2) + "pt") : PrefUtils.getFontSizeText(2 );
        ...
        String headingFontFace = headingFamily.isEmpty() ? "" : ("@font-face { font-family:\"HeadingFont\"; src: url(\"" + GetTypeFaceLocalUrl(headingFamily, isEditingMode) + "\");}\n");
        ...
        return "<head><style type='text/css'> "
                ...
                + "title, h1 {font-size: " + h1Size + "; margin-top: 1.0cm; margin-bottom: 0.1em}\n "
                + "h2 {font-size: " + h2Size + "}\n "
